...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.descripcion_name_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
        ...
        OutlinedTextField(
            value = itemDetails.genero,
            onValueChange = { onValueChange(itemDetails.copy(genero = it)) },
            label = { Text(stringResource(R.string.genero_name_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
        ...
        OutlinedTextField(
            value = itemDetails.numcam,
            onValueChange = { onValueChange(itemDetails.copy(numcam = it)) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
            label = { Text(stringResource(R.string.numcan_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
...
private fun ItemEntryScreenPreview() {
    InventoryTheme {
        ItemEntryBody(itemUiState = ItemUiState(
            ItemDetails(
                name = "Rock", descripcion = "Rockea con esta playlist", genero = "Rock", numcam = "5"
            )
